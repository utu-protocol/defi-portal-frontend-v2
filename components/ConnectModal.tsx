...
export default function ConnectModal({connect, open, setOpen}:ConnectModalProps): ReactElement {
...
//   }
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="fixed z-0 inset-0 overflow-y-auto" initialFocus={cancelButtonRef} onClose={setOpen}>
          ...
          >
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-xs text-gray-500">
                        Please, Input your wallet address or ENS domain manually or connect it. 
                      </p>
                    </div>
                  </div>
                </div>
                            <form className="mt-8 flex flex-col" aria-labelledby="newsletter-headline">
              ...
              <p className="my-5 text-center justify-center w-full">OR</p>
                <button
                  type="button"
                  className="rounded-md shadow inline-flex justify-between rounded-md border border-transparent shadow-sm px-4 py-3 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:w-auto "
                  onClick={() => connect()}
                >
                  CONNECT YOUR WALLET
                <LoginIcon className="h-6 w-6" aria-hidden="true" />
                </button>
                              <p className="font-light my-5 text-center text-gray-400 text-sm justify-center w-full">Supported: Metamask, WalletConnect, Coinbase</p>
